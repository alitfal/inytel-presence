<script setup>
/**
 * AdminLayout.vue — Layout principal del panel de administración
 *
 * Componente contenedor que envuelve todas las vistas de administrador.
 * Proporciona la estructura visual completa incluyendo:
 * - Navbar superior con buscador y reloj
 * - Sidebar de navegación (visible solo en desktop lg+)
 * - Barra de navegación inferior (visible solo en móvil/tablet)
 * - Slot para el contenido de cada vista
 *
 * Props:
 * @prop {String} searchQuery - Texto del buscador (v-model desde el padre)
 *
 * Eventos emitidos:
 * @emits update:searchQuery - Sincroniza el buscador con el componente padre
 * @emits abrir-nuevo        - Solicita abrir el formulario de nuevo empleado
 * @emits cambiar-password   - Solicita abrir el modal de cambio de contraseña
 */
...
// Controla la visibilidad del sidebar en móvil (drawer)
...
/**
 * Navega a la ruta indicada y cierra el sidebar en móvil.
...
// Items de navegación principal del sidebar y barra inferior
const navItems = [
  ...
  <div class="min-h-screen bg-slate-50 flex flex-col">
    ...
    <div class="flex flex-1 relative">
      <!--
        ...
        En tablet y móvil se sustituye por la barra inferior
      ...
      <!-- Área de contenido principal — renderiza la vista activa mediante slot -->
    ...
    <!--
      Barra de navegación inferior — solo visible en móvil/tablet (lg:hidden)
