    ...
    <main class="max-w-6xl mx-auto px-6 py-8">
      ...
      <template v-else-if="empleado">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:items-start">
          ...
          <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm overflow-hidden" style="height: 655px">
            ...
            <div class="flex gap-2 mb-3">
              <button
                ...
                :key="p.key" @click="cambiarPeriodo(empleado.id, p.key)"
            ...
            <div v-else class="space-y-2 overflow-y-auto pr-1" style="max-height: calc(655px - 130px)">
