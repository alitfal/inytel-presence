...
Queda permitido descargar y compartir este trabajo siempre que se mencione al autor original.

Queda expresamente prohibido:
- Modificar, transformar o crear obras derivadas.
- Usar el proyecto con fines comerciales.
- Distribuir el proyecto sin mencionar al autor.

Para cualquier uso no contemplado en esta licencia, contacta con el autor a través del repositorio oficial del proyecto:
https://github.com/alitfal/inytel-presence

Más información sobre la licencia en:
https://creativecommons.org/licenses/by-nc-nd/4.0/deed.es

© 2026 Angel Luis Litago Falces · C.F.G.S. Desarrollo de Aplicaciones Web
